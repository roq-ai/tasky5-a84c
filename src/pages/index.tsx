  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of organization with Tasky5, your reliable companion for managing your daily tasks efficiently and effectively."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of organization with Tasky5, your reliable companion for managing your daily tasks efficiently and effectively.`}
            </Text>
            <Box
